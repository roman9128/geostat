...
public class NumericInfoLoader extends XLSXDataLoader {
    ...
    /**
     * Карта с загруженной ранее информацией.
     */
    private Map map;
    /**
     * Заголовки для числовых данных.
     */
     ...
     * Конструктор класса.
     *
     * @param map объект класса Map (карта), содержащий в себе территории,
     * информацию о которых нужно загрузить
    ...
    /**
     * Метод отправки загруженной информации.
     *
     * @return объект класса Map
     */
    public Map sendMap() {
    ...
    /**
     * Во избежание ошибок, связанных с неполным заполнением ячеек таблицы
     * XLSX-файла, в расчёт принимаются только данные из столбцов, имеющих
     * заголовки, все иные данные не учитываются. Если длина массива с данными
     * меньше длины массива с заголовками, то создаётся новый массив с данными
     * длиной, соответствующей длине массива с заголовками. Метод для записи
     * числовой информации о территории.
     */
    @Override
